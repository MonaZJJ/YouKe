            ...
            columns: [{
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        if (row.Illicit == 0) {
                            html += "<span class='banned' data-id='" + value + "' style='cursor: pointer;color: #039cf8;'>禁言</span>";
                        } else {
                            html += "<span class='remove_banned' data-id='" + value + "' style='cursor: pointer;color: #039cf8;'>解除禁言</span>";
                        }
