...
var MatchList = {
    ...
    initBootstrapTable: function () {
        $('#productTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/AdminUser/AdminGetUserActivityList',
            dataType: "json",
            ...
            columns: [{
...

                {
                    ...
                    formatter: function (value, row, index) {
                        var html = "";
                        html += "<a href='/production/productionDetail?id=" + value + "' style='margin-right: 15px;color: #039cf8;' data-id='" + value + "'>作品</a>";
    ...
    queryParams: function (params) {
        //配置参数
        //方法名
        var methodName = "/AdminUser/AdminGetUserActivityList";
